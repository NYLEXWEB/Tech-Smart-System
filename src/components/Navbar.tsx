  ...
  return (
    <header
      className={`fixed left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "top-3 sm:top-4 max-w-6xl mx-4 sm:mx-auto rounded-full bg-white/95 backdrop-blur-md shadow-md border border-slate-200/90 py-1.5 sm:py-2 px-5 sm:px-8"
          : mobileMenuOpen
          ? "top-0 bg-white shadow-sm py-2.5 px-5 sm:px-8 border-b border-slate-200"
          : "top-0 bg-transparent py-3.5 sm:py-4 px-5 sm:px-8 border-b border-transparent"
      }`}
    >
